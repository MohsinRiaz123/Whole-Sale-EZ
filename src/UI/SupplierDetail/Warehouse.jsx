...
import NewWarehouseForm from "../../Components/Model/NewWarehouseForm";
...
const Vendor = () => {
  ...
  return (
    <div>
      <div className="mt-5 font-semibold text-xl">Warehouses List</div>
      <div className="border my-5 rounded-md shadow-md">
        ...
        <div className="">
          {/* Header Row */}
          <div className="w-ful pt-6 text-xs lg:text-base px-5 text-gray-400 font-semibold grid grid-cols-4 gap-10">
          ...
          {currentProducts.map((data, i) => (
            <div
              className="cursor-pointer px-5 text-xs lg:text-base py-4 text-gray-700 border-b grid grid-cols-4 gap-10"
              key={i}
            >
              ...
              <div className="flex gap-3 flex-col px-2 sm:flex-row">
